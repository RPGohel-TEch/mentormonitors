...
const Database = () => {
  return (
    <div className="Database">
            ...
            <div className="course-component">
              ...
              <div className="subject-cards-main">
                <div className="subject-card">
                  ...
                  <div className="subject-name">IMSCIT</div>
      ...
      <div className="modal fade" id="openfacultymodification" tabIndex={-1} role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div className="modal-dialog modal-dialog-centered" role="document">
    <div className="modal-content custom-modal-content">
      <div className="modal-header custom-modal-header">
        <h5 className="modal-title custom-modal-title" id="exampleModalLabel">Edit Faculty</h5>
          ...
          <div className="modal-content custom-modal-content">
            ...
            <div className="modal-body custom-modal-body">
              ...
              <div className="confirmation-answer ">
                <div className="cancel-object" data-dismiss="modal"
                aria-label="Close">Cancel</div>
