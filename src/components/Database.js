...
const Database = () => {
  ...
  const getcourseData = async () => {
    const { data } = await axios.get(`https://mentor-backend-git-main-mentormonitor.vercel.app/course/`);
  ...
  const courseSubmit = (e) => {
    e.preventDefault();
    axios.post('https://mentor-backend-git-main-mentormonitor.vercel.app/course/add-course', {
  ...
  const courseEditData = async(id) => {
    setCourseEditId(id);
    const { data } = await axios.get(`https://mentor-backend-git-main-mentormonitor.vercel.app/course/${id}`);
  ...
  const courseEdit = (e) => {
    e.preventDefault();
    axios.put(`https://mentor-backend-git-main-mentormonitor.vercel.app/course/edit-course/${courseEditId}`, {
  ...
  const deleteCourse = (id) => {
    axios.delete(`https://mentor-backend-git-main-mentormonitor.vercel.app/course/delete-course/${id}`)
    .then(function() {
      getcourseData()
    })
  } 
  ...
  const subjectSubmit = (e) => {
    e.preventDefault();
    axios.post('https://mentor-backend-git-main-mentormonitor.vercel.app/subject/add-subject', {
                        ...
                        >
                          <div className="student-head-card d-flex w-100">
                            ...
                            <div className="name-and-enrollment d-flex align-items-center justify-content-between">
                              <div className="student-name">Ramika Sen</div>
                              <div className="student-enrollment">2457634</div>
                            </div>
                        ...
                        <div className="accordion-body d-flex">
                          <div className="student-details-section">
                            <div className="basic-detail-blackboard">
                              ...
                              <div className="student-info-card">
                                <b>Address:</b> A/41 ramrajya nagar, nr. ayodhya
                                park, nikol, Ahmedabad.
                              </div>
                            </div>
        ...
        <div className="modal-dialog modal-dialog-centered" role="document">
          <div className="modal-content custom-modal-content">
            ...
            <div className="modal-body custom-modal-body">
              <form className="student-detail-edit-form" action="">
                <label htmlFor="">Subject Name:</label>
                <input type="text" value="Digital Fundamentals" />
                <br />
          ...
          <div className="modal-content custom-modal-content">
            ...
            <div className="modal-body custom-modal-body">
              ...
              <div className="confirmation-answer ">
                ...
                <div className="delete-object"> Delete</div>
              </div>
            </div>
          </div>
        </div>
